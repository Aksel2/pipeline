...
class BPMNGraph:
    ...
    def capture_gateway_state(self, gateway_id, gateway_type, decision_made, outgoing_flows):
        ...
        if (
            hasattr(self, '_target_gateway_id')
            and self._target_gateway_id is not None
            and gateway_id == self._target_gateway_id
        ):
    ...
    def replay_trace(
        ...
        target_gateway_id: str = None, outcome_mapping: dict = None
    ):
        self._c_trace = trace
        self._target_gateway_id = target_gateway_id
        ...
        for current_index in range(len(task_sequence)):
            self._current_task_index = current_index
        ...
        gateway_decisions = self._gateway_decisions
        self._c_trace = None
        self._target_gateway_id = None
